...
class AWSCloudWatchMetricsIntegration(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="eventstorecloud:index/aWSCloudWatchMetricsIntegration:AWSCloudWatchMetricsIntegration")])
        ...
        super(AWSCloudWatchMetricsIntegration, __self__).__init__(
            'kurrentcloud:index/aWSCloudWatchMetricsIntegration:AWSCloudWatchMetricsIntegration',
            resource_name,
            __props__,
            opts)
