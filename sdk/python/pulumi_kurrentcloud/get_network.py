...
def get_network(name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('kurrentcloud:index/getNetwork:getNetwork', __args__, opts=opts, typ=GetNetworkResult).value
    ...
    return AwaitableGetNetworkResult(
        ...
        resource_provider=pulumi.get(__ret__, 'resource_provider'))
