...
class ManagedCluster(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="eventstorecloud:index/managedCluster:ManagedCluster")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(ManagedCluster, __self__).__init__(
            'kurrentcloud:index/managedCluster:ManagedCluster',
            resource_name,
            __props__,
            opts)
