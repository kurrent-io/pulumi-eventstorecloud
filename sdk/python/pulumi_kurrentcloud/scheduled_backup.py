...
class ScheduledBackup(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="eventstorecloud:index/scheduledBackup:ScheduledBackup")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(ScheduledBackup, __self__).__init__(
            'kurrentcloud:index/scheduledBackup:ScheduledBackup',
            resource_name,
            __props__,
            opts)
