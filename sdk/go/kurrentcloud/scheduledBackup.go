...
func NewScheduledBackup(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		{
			Type: pulumi.String("eventstorecloud:index/scheduledBackup:ScheduledBackup"),
		},
	})
	opts = append(opts, aliases)
	opts = internal.PkgResourceDefaultOpts(opts)
	var resource ScheduledBackup
	err := ctx.RegisterResource("kurrentcloud:index/scheduledBackup:ScheduledBackup", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetScheduledBackup(ctx *pulumi.Context,
	...
	var resource ScheduledBackup
	err := ctx.ReadResource("kurrentcloud:index/scheduledBackup:ScheduledBackup", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
