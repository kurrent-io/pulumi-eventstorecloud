...
func NewAWSCloudWatchLogsIntegration(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		{
			Type: pulumi.String("eventstorecloud:index/aWSCloudWatchLogsIntegration:AWSCloudWatchLogsIntegration"),
		},
	})
	...
	err := ctx.RegisterResource("kurrentcloud:index/aWSCloudWatchLogsIntegration:AWSCloudWatchLogsIntegration", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetAWSCloudWatchLogsIntegration(ctx *pulumi.Context,
	...
	var resource AWSCloudWatchLogsIntegration
	err := ctx.ReadResource("kurrentcloud:index/aWSCloudWatchLogsIntegration:AWSCloudWatchLogsIntegration", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
