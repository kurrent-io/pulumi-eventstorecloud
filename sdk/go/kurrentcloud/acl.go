...
type Acl struct {
	...
	CidrBlocks pulumi.MapArrayOutput `pulumi:"cidrBlocks"`
...
func NewAcl(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		{
			Type: pulumi.String("eventstorecloud:index/acl:Acl"),
		},
	})
	opts = append(opts, aliases)
	opts = internal.PkgResourceDefaultOpts(opts)
	var resource Acl
	err := ctx.RegisterResource("kurrentcloud:index/acl:Acl", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetAcl(ctx *pulumi.Context,
	...
	var resource Acl
	err := ctx.ReadResource("kurrentcloud:index/acl:Acl", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
type aclState struct {
	// CIDR blocks allowed by the IP access list
	CidrBlocks []map[string]interface{} `pulumi:"cidrBlocks"`
	// Human-friendly name for the Acl
...
type AclState struct {
	// CIDR blocks allowed by the IP access list
	CidrBlocks pulumi.MapArrayInput
	// Human-friendly name for the Acl
...
// CIDR blocks allowed by the IP access list
func (o AclOutput) CidrBlocks() pulumi.MapArrayOutput {
	return o.ApplyT(func(v *Acl) pulumi.MapArrayOutput { return v.CidrBlocks }).(pulumi.MapArrayOutput)
}
...
// Project ID
func (o AclOutput) ProjectId() pulumi.StringOutput {
	return o.ApplyT(func(v *Acl) pulumi.StringOutput { return v.ProjectId }).(pulumi.StringOutput)
}
