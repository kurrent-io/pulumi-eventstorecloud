...
namespace Pulumi.KurrentCloud
{
    static class Utilities
    {
        ...
        public static global::Pulumi.InvokeOptions WithDefaults(this global::Pulumi.InvokeOptions? src)
        {
            ...
            dst.PluginDownloadURL = src?.PluginDownloadURL ?? "github://api.github.com/kurrent-io";
            return dst;
        }
        ...
        static Utilities()
        {
            ...
            using var stream = assembly.GetManifestResourceStream("Pulumi.KurrentCloud.version.txt");
    ...
    internal sealed class KurrentCloudResourceTypeAttribute : global::Pulumi.ResourceTypeAttribute
    {
        public KurrentCloudResourceTypeAttribute(string type) : base(type, Utilities.Version)
        {
        }
    }
}
